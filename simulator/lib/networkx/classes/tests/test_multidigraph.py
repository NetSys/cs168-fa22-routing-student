...
class BaseMultiDiGraphTester(BaseMultiGraphTester):
    ...
    def test_edges(self):
        ...
        G.add_edge(0, 1)
        assert_equal(
            sorted(G.edges()), [(0, 1), (0, 1), (0, 2), (1, 0), (1, 2), (2, 0), (2, 1)]
        )

    def test_out_edges(self):
        G = self.K3
        assert_equal(
            sorted(G.out_edges()), [(0, 1), (0, 2), (1, 0), (1, 2), (2, 0), (2, 1)]
        )
    ...
    def test_out_edges_data(self):
        ...
        assert_equal(
            sorted(G.edges(0, data="data", default=-1)), [(0, 1, 1), (0, 2, -1)]
        )

    def test_in_edges(self):
        G = self.K3
        assert_equal(
            sorted(G.in_edges()), [(0, 1), (0, 2), (1, 0), (1, 2), (2, 0), (2, 1)]
        )
    ...
    def test_in_edges(self):
        ...
        assert_equal(
            sorted(G.in_edges(data=True, keys=False)),
            [
                (0, 1, {}),
                (0, 1, {}),
                (0, 2, {}),
    ...
    def test_in_edges_data(self):
        ...
        assert_equal(
            sorted(G.in_edges(0, data=True)), [(1, 0, {"data": 1}), (2, 0, {})]
        )
        assert_equal(sorted(G.in_edges(0, data="data")), [(1, 0, 1), (2, 0, None)])
        assert_equal(
            sorted(G.in_edges(0, data="data", default=-1)), [(1, 0, 1), (2, 0, -1)]
        )
...
class TestMultiDiGraph(BaseMultiDiGraphTester, TestMultiGraph):
    ...
    def test_remove_edge(self):
        ...
        assert_equal(
            G._succ,
            {0: {2: {0: {}}}, 1: {0: {0: {}}, 2: {0: {}}}, 2: {0: {0: {}}, 1: {0: {}}}},
        )
        assert_equal(
            G._pred,
            {0: {1: {0: {}}, 2: {0: {}}}, 1: {2: {0: {}}}, 2: {0: {0: {}}, 1: {0: {}}}},
        )
        assert_raises((KeyError, nx.NetworkXError), G.remove_edge, -1, 0)
        assert_raises((KeyError, nx.NetworkXError), G.remove_edge, 0, 2, key=1)
