...
class HistoricalTests(object):
    ...
    def test_add_nodes_from(self):
        ...
        assert_equal(
            sorted(G.nodes(), key=str), [1, 2, 3, 4, "A", "B", "C", "D", "E", "F", "G"]
        )
        # test __iter__
        assert_equal(
            sorted(G, key=str), [1, 2, 3, 4, "A", "B", "C", "D", "E", "F", "G"]
        )
    ...
    def test_nbunch_is_list(self):
        ...
        assert_equal(sorted(G.nodes(), key=str), [1, 2, 3, "A", "B", "C", "D"])
        G.remove_nodes_from(self.P3)  # remove nbunch of nodes (nbunch=Graph)
        assert_equal(sorted(G.nodes(), key=str), ["A", "B", "C", "D"])
    ...
    def test_nbunch_dict(self):
        ...
        assert_true(
            sorted(G.nodes(), key=str), ["A", "B", "C", "D", "E", "F", "G", "H"]
        )
    ...
    def test_iterators(self):
        ...
        G.add_edges_from([("A", "B"), ("A", "C"), ("B", "D"), ("C", "B"), ("C", "D")])
        G.add_nodes_from("GJK")
        assert_equal(sorted(G.nodes()), ["A", "B", "C", "D", "G", "J", "K"])
        assert_edges_equal(
            G.edges(), [("A", "B"), ("A", "C"), ("B", "D"), ("C", "B"), ("C", "D")]
        )

        assert_equal(sorted([v for k, v in G.degree()]), [0, 0, 0, 2, 2, 3, 3])
        assert_equal(
            sorted(G.degree(), key=str),
